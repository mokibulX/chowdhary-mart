...
export const ordersTable = pgTable("orders", {
  ...
  calculatedDistanceKm: decimal("calculated_distance_km", { precision: 8, scale: 2 }),
  deliveryRatePerKm: decimal("delivery_rate_per_km", { precision: 10, scale: 2 }).notNull().default("0"),
  deliveryFullCharge: decimal("delivery_full_charge", { precision: 10, scale: 2 }).notNull().default("0"),
  deliveryFirstItemCharge: decimal("delivery_first_item_charge", { precision: 10, scale: 2 }).notNull().default("0"),
  deliveryAdditionalItemPercentage: decimal("delivery_additional_item_percentage", { precision: 5, scale: 2 }).notNull().default("50"),
  deliveryAdditionalItemCharge: decimal("delivery_additional_item_charge", { precision: 10, scale: 2 }).notNull().default("0"),
  deliveryEligibleItemCount: integer("delivery_eligible_item_count").notNull().default(1),
  deliverySecondItemCharge: decimal("delivery_second_item_charge", { precision: 10, scale: 2 }).notNull().default("0"),
  deliveryThirdItemCharge: decimal("delivery_third_item_charge", { precision: 10, scale: 2 }).notNull().default("0"),
  deliveryFreeItemCount: integer("delivery_free_item_count").notNull().default(0),
  finalCustomerAmount: decimal("final_customer_amount", { precision: 10, scale: 2 }).notNull().default("0"),
