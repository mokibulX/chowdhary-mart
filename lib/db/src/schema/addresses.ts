...
export const addressesTable = pgTable("addresses", {
  ...
  line2: text("line2"),
  city: varchar("city", { length: 100 }).notNull().default("Hatsingimari"),
  district: varchar("district", { length: 120 }),
  state: varchar("state", { length: 100 }).notNull().default("Assam"),
  pincode: varchar("pincode", { length: 10 }).notNull().default("783135"),
  lat: real("lat"),
  lng: real("lng"),
